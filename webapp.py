...
with col_chart1:
    ...
    ax1.set_title("Budget Comparison", fontsize=14, color="#000000", pad=20)  # Title color and padding
...
with col_chart2:
    ...
    ax2_left.set_title("Future Sites Funded & % Savings", fontsize=14, color="#000000", pad=20)  # Title color and padding
