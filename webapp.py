...
with col_left:
    st.markdown("### Customer Input", unsafe_allow_html=True)
...
with col_right:
    ...
    st.image("logo.png", width=450)  # Adjust width as needed
...
with col_chart1:
    ...
    ax1.set_title("Budget Comparison", fontsize=14, color="#000000", pad=10)  # Title color and padding
    
    # Set background color for the title
    ax1.title.set_backgroundcolor("#cef5f1")  # Background color for the title
...
with col_chart2:
    ...
    ax2_left.set_title("Future Sites Funded & % Savings", fontsize=14, color="#000000", pad=10)  # Title color and padding

    # Set background color for the title
    ax2_left.title.set_backgroundcolor("#cef5f1")  # Background color for the title
